...
int main() {
    ...
    printf("\nYour starting daily limit is: %.2f\n", newDailyLimit);
    printf("Let's plan your week wisely!\n\n");
    ...
    for (day = 1; day <= 7; day++) {
        ...
        printf("\nEnter how much you actually spent today: ");
        scanf("%f", &dailySpent);
    ...
    printf("\n💡 Tip: Keep Essentials at 50%%, Leisure at 30%%, and Savings at 20%% each day.\n");
